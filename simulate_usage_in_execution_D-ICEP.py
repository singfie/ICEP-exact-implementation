...
def main():
    ...
    # calculate in the time passed
    information = rel_path.split('_')
    updates = float(information[-3])
    interval = float(information[-6])
    time_passed = updates * interval

    # update existing_route_plan
