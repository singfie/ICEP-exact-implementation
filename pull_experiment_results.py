            ...
            if 'TRUE_DEMAND_REVEAL' in solutions:
                try:
                    ...
                    for v in np.unique(result_as_per_alg['resource_id']):
                        ...
                        time_utilization = time_utilized/sub_frame_per_alg['load_end_time'].max()
                        time_utilizations_as_per_alg.append(time_utilization)
                    avg_utilization_as_per_alg = time_utilizations.mean()
                    ...
                    for v in np.unique(true_result['resource_id']):
                        ...
                        time_utilization = time_utilized_true/sub_frame_true['load_end_time'].max()
                        time_utilizations_true.append(time_utilization)
                    avg_utilization_true = time_utilizations_true.mean()
