...
def main():
    ...
    existing_route_plan = pd.read_csv(os.path.join(path, 'Solutions', 'route_plan_scenario_GUROBI_gamma_' + str(gamma) + '.csv'))
    ...
    existing_route_plan.to_csv(os.path.join(path, 'Solutions', 'route_plan_scenario_GUROBI_gamma_' + str(gamma) + '_after_TRUE_DEMAND_REVEAL.csv'), index = False)
